      ...
      <div className="w-full bg-white flex flex-col items-center">
        <div className="flex flex-col gap-4 w-full items-center p-8 max-w-screen-2xl">
          ...
          <p>
            ...
            firmasına gitmeyin. Size özel hizmet vermek için Neirt’e güvenebilirsiniz, böylece ürünlerinizi pazarlama stratejinizden en iyi şekilde
            yararlanabilirsiniz!
          </p>
          <p>
            <strong>Web Sitesi Optimizasyonu</strong>
            <br />
            Hedef pazarınız ve rakiplerinizin araştırmasıyla Neirt, web sitenizi arama için optimize etme sürecine başlar. Arama sonuçlarında bir başlık etiketi
