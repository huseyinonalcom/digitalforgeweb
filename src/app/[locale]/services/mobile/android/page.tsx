    ...
    <div className="w-full flex flex-col items-center">
      ...
      <div className="w-full bg-white flex flex-col items-center">
        <div className="flex flex-col gap-4 w-full items-center p-8 max-w-screen-xl">
          <p>{t("android-app-intro")}</p>
          <p>
            <strong>{t("android-app-title-1")}</strong>
            <br />
            {t("android-app-text-1")}
          </p>
          <p>{t("android-app-text-1-b")}</p>
          <p>
            <strong>{t("android-app-title-2")}</strong>
            <br />
            {t("android-app-text-2")}
          </p>
          <p>{t("android-app-text-2-b")}</p>
          <p>
            <strong>{t("android-app-title-3")}</strong>
            <br />
            {t("android-app-text-3")}
          </p>
          <p>
            <strong>{t("android-app-title-4")}</strong>
            <br />
            {t("android-app-text-4")}
          </p>
        </div>
      </div>
    </div>
