    ...
    <div className="w-full">
      <div className="relative">
        <input
          ...
          id={name}
          className="block pb-1.5 pt-3 px-2.5 bg-white w-full text-sm text-black bg-transparent -0 border-2 border-[#321b7a] outline-none focus:ring-0 focus:border-[var(--theme-color-main)] peer rounded-md"
          placeholder=""
        />
        <label
          htmlFor={name}
